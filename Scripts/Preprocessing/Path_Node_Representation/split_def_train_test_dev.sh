...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/WordNet/Graph/Animal/'

SYNS_DEF_FILT_FILE='animal_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/WordNet/Definitions/Animal/'
IS_WORDNET='1'
...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/WordNet/Graph/Plant/'

SYNS_DEF_FILT_FILE='plant_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/WordNet/Definitions/Plant/'
IS_WORDNET='1'
python split_def_train_test_dev.py $SYNS_DEF_FILE $SYNS_DEF_DIR\
                                $TARGET_SYN_FILE $TARGET_SYN_DIR\
                                $SYNS_DEF_FILT_FILE $SYNS_DEF_FILE_DIR $IS_WORDNET
...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/WordNet/Graph/Entity/'

SYNS_DEF_FILT_FILE='entity_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/WordNet/Definitions/Entity/'
IS_WORDNET='1'
python split_def_train_test_dev.py $SYNS_DEF_FILE $SYNS_DEF_DIR\
                                $TARGET_SYN_FILE $TARGET_SYN_DIR\
                                $SYNS_DEF_FILT_FILE $SYNS_DEF_FILE_DIR $IS_WORDNET
...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/HPO/Graph/'

SYNS_DEF_FILT_FILE='hpo_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/HPO/Definitions/'
IS_WORDNET='0'
python split_def_train_test_dev.py $SYNS_DEF_FILE $SYNS_DEF_DIR\
                                $TARGET_SYN_FILE $TARGET_SYN_DIR\
                                $SYNS_DEF_FILT_FILE $SYNS_DEF_FILE_DIR $IS_WORDNET
...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/PATO/Graph/'

SYNS_DEF_FILT_FILE='pato_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/PATO/Definitions/'
IS_WORDNET='0'
python split_def_train_test_dev.py $SYNS_DEF_FILE $SYNS_DEF_DIR\
                                $TARGET_SYN_FILE $TARGET_SYN_DIR\
                                $SYNS_DEF_FILT_FILE $SYNS_DEF_FILE_DIR $IS_WORDNET
...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/GO/Graph/'

SYNS_DEF_FILT_FILE='go_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/GO/Definitions/'
IS_WORDNET='0'
python split_def_train_test_dev.py $SYNS_DEF_FILE $SYNS_DEF_DIR\
                                $TARGET_SYN_FILE $TARGET_SYN_DIR\
                                $SYNS_DEF_FILT_FILE $SYNS_DEF_FILE_DIR $IS_WORDNET
...
TARGET_SYN_DIR='../../../Data/Path_Node_Representation/DO/Graph/'

SYNS_DEF_FILT_FILE='do_train_node_definitions.txt'
SYNS_DEF_FILE_DIR='../../../Data/Path_Node_Representation/DO/Definitions/'
IS_WORDNET='0'
python split_def_train_test_dev.py $SYNS_DEF_FILE $SYNS_DEF_DIR\
                                $TARGET_SYN_FILE $TARGET_SYN_DIR\
                                $SYNS_DEF_FILT_FILE $SYNS_DEF_FILE_DIR $IS_WORDNET
